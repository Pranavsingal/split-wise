          ...
          {balances.length === 0 ? (
            ...
            <>
              <div>
                ...
                <select
                  className="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white outline-none"
                  value={selectedPayee}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="number"
                    step="0.01"
                    className="w-full pl-8 pr-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none"
                    value={amount}
